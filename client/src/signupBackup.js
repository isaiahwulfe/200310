    ...
    >
      ...
      <Grid item xs={8}>
        <Grid 
          ...
          >
          <Grid item>
            <Typography color="secondary" style={{marginTop:"2.75rem"}}>Already have an account?</Typography>
          </Grid>
          <Grid item>
            <Button href="/login" variant="contained" style={{padding:".75rem 3rem",margin:"2rem 4rem 0 2rem", color:"#3A8DFF", backgroundColor:"#FFF"}}>Login</Button>
          </Grid>
        </Grid>
        <form onSubmit={handleRegister}>
          <Grid 
            ...
            >
              ...
              <Grid item xs={10} className="input-container">
                <FormControl error={!!formErrorMessage.confirmPassword} className="input-text">
                  <TextField
                    aria-label="password"
                    label="Password"
                    type="password"
              ...
              <Button type="submit" variant="contained" size="large" style={{position:"relative", left:"50%", transform: "translate(-50%, 0)", padding:".75rem 0 .75rem 0", marginTop:"3rem", width:"10rem", color:"#3A8DFF", backgroundColor:"#FFF"}}>
                Create
              </Button>
          </Grid>
        </form>  
